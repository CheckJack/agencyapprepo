    ...
    try {
      ...
      if (result?.error) {
        ...
        if (session?.user?.role === 'AGENCY_ADMIN' || session?.user?.role === 'AGENCY_STAFF') {
          ...
          // Show loading screen for client users
          setShowClientLoading(true);
          // Navigate after a brief moment to allow loading screen to render
          setTimeout(() => {
            router.push('/client');
          }, 100);
        } else {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 bg-background border-border/60 focus:border-primary text-foreground"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-background border-border/60 focus:border-primary text-foreground"
                />
                <button
                  type="button"
